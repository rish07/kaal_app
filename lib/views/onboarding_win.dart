...
class OnboardindWin extends StatefulWidget {
  const OnboardindWin({Key key}) : super(key: key);

  @override
  _OnboardindWinState createState() => _OnboardindWinState();
}

class _OnboardindWinState extends State<OnboardindWin> {
